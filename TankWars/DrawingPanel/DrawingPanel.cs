  ...
  public class DrawingPanel : Panel
  {
    ...
    private void PlayerDrawer(object o, PaintEventArgs e)
    {
      ...
      using (System.Drawing.SolidBrush greenBrush = new System.Drawing.SolidBrush(System.Drawing.Color.Green))
      {
        ...
        private void PieDrawer(object o, PaintEventArgs e)
        {
            Player p = o as Player;
            ...
            using (System.Drawing.SolidBrush greenBrush = new System.Drawing.SolidBrush(System.Drawing.Color.Green))
            {
                ...
                if (p.GetTeam() == 1) // team 1 is blue
                    e.Graphics.FillPie(blueBrush, r, 120, 30);
                else                  // team 2 is green
                    e.Graphics.FillRectangle(greenBrush, r);
            }
        }
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
      ...
      e.Graphics.TranslateTransform(viewSize / 2, viewSize / 2);
            ...
            lock (theWorld)
            {
                ...
                {
                    DrawObjectWithTransform(e, play, play.GetLocation().GetX(), play.GetLocation().GetY(), play.GetOrientation().ToAngle(), PieDrawer);
                }
